...
<table width="70%" border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	...
	<tr>
		...
		<td><input type="radio" name="sex" value="1" <?php echo @$row['sex']=='男'? "checked='checked'": '';?> />男
		<input type="radio" name="sex" value="2" <?php echo @$row['sex']=='女'?"checked='checked'" : '';?>  />女
		<input type="radio" name="sex" value="0" <?php echo @$row['sex']=='保密'?"checked='checked'" : '';?> />保密</td>
	</tr>
	<tr>
