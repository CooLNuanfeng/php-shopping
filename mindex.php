...
<div class="shopList comWidth clearfix">
	...
	<div class="rightArea">
		...
		<?php
			@$pros=getProsByCid($cate['id'],true);
		...
		?>
			<div class="shop_item">
				<div class="shop_img">
					<a href="proDetails.php?id=<?php echo $pro['id'];?>" target="_blank"><img height="200" width="187" src="admin/uploads/images_200/<?php echo $proImg['albumPath'];?>" alt=""></a>
				</div>
		...
		<?php
			@$prosSmall=getProsByCid($cate['id'],false);
		...
		?>
			<div class="shopItem_sm">
				<div class="shopItem_smImg">
					<a href="proDetails.php?id=<?php echo $proSmall['id'];?>" target="_blank"><img width="95" height="95" src="admin/uploads/image_200/<?php echo $proSmallImg['albumPath'];?>" alt=""></a>
				</div>
